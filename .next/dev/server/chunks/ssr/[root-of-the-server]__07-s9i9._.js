...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$groq$2f$groq$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/groq/groq.js [app-rsc] (ecmascript)");
;
const PROJECTS_QUERY = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$groq$2f$groq$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["defineQuery"])(`
...
function sanityImageUrl(image, width) {
    ...
    const builder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$sanity$2f$image$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["urlFor"])(image);
...
function mapSanityProject(project) {
    const cardImage = sanityImageUrl(project.mainImage, 1200) ?? sanityImageUrl(project.coverImage, 1200) ?? "/placeholder.svg";
    const gallery = project.gallery?.map(mapGalleryItem).filter((item)=>item !== null) ?? [];
    const category = typeof project.category === "string" ? project.category : project.categoryTitle ?? "Otro";
    return {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07-s9i9._.js.map