    ...
    if (tag && options.tag !== null && (options.query = {
        ...
        if (typeof variantOption < "u" && (typeof variantOption == "string" && (options.query = {
            ...
            if (variantConditions.length > 1) {
                ...
                console.warn(`The Sanity client's beta \`variant\` option currently only supports one condition. Dropped: ${formatter.format(variantConditions.slice(1).map(([subject])=>JSON.stringify(subject)))}.`);
            }
            options.query = {
...
"[project]/node_modules/groq/groq.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=node_modules_08rz~br._.js.map